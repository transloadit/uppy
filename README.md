...
Add CSS [uppy.min.css](https://transloadit.edgly.net/releases/uppy/v1.10.1/uppy.min.css), either to your HTML page's `<head>` or include in JS, if your bundler of choice supports it — transforms and plugins are available for Browserify and Webpack.
