...
Add CSS [uppy.min.css](https://releases.transloadit.com/uppy/v2.12.3/uppy.min.css), either to your HTML page’s `<head>` or include in JS, if your bundler of choice supports it.
...
```html
<script src="https://releases.transloadit.com/uppy/v2.12.3/uppy.legacy.min.js"></script>
```
