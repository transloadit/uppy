...
Add CSS [uppy.min.css](https://releases.transloadit.com/uppy/v2.13.5/uppy.min.css), either to your HTML page’s `<head>` or include in JS, if your bundler of choice supports it.
...
<script src="https://releases.transloadit.com/uppy/v2.13.5/uppy.min.js"></script>
...
```html
<script src="https://releases.transloadit.com/uppy/v2.13.5/uppy.legacy.min.js"></script>
```
