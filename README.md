...
Add CSS [uppy.min.css](https://releases.transloadit.com/uppy/v3.2.1/uppy.min.css), either to your HTML page’s `<head>` or include in JS, if your bundler of choice supports it.
...
<script type="module">
  import { Uppy, Dashboard, Tus } from "https://releases.transloadit.com/uppy/v3.2.1/uppy.min.mjs"
...
```html
<script src="https://releases.transloadit.com/uppy/v3.2.1/uppy.legacy.min.js"></script>
```
