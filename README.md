...
Add CSS
[uppy.min.css](https://releases.transloadit.com/uppy/v3.27.2/uppy.min.css),
...
<!-- 1. Add CSS to `<head>` -->
<link
  href="https://releases.transloadit.com/uppy/v3.27.2/uppy.min.css"
  rel="stylesheet"
/>
...
<script type="module">
  import {
    ...
    Dashboard,
    Tus,
  } from 'https://releases.transloadit.com/uppy/v3.27.2/uppy.min.mjs'
...
```html
<script src="https://releases.transloadit.com/uppy/v3.27.2/uppy.legacy.min.js"></script>
```
