...
Add CSS [uppy.min.css](https://releases.transloadit.com/uppy/v1.25.0/uppy.min.css), either to your HTML page's `<head>` or include in JS, if your bundler of choice supports it — transforms and plugins are available for Browserify and Webpack.
