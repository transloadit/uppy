...
Add CSS
[uppy.min.css](https://releases.transloadit.com/uppy/v3.28.0/uppy.min.css),
...
<!-- 1. Add CSS to `<head>` -->
<link
  href="https://releases.transloadit.com/uppy/v3.28.0/uppy.min.css"
  rel="stylesheet"
/>
...
<script type="module">
  import {
    ...
    Dashboard,
    Tus,
  } from 'https://releases.transloadit.com/uppy/v3.28.0/uppy.min.mjs'
...
```html
<script src="https://releases.transloadit.com/uppy/v3.28.0/uppy.legacy.min.js"></script>
```
