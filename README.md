...
Add CSS [uppy.min.css](https://releases.transloadit.com/uppy/v2.11.1-0/uppy.min.css), either to your HTML page’s `<head>` or include in JS, if your bundler of choice supports it.
...
```html
<!-- 1. Add CSS to `<head>` -->
<link href="https://releases.transloadit.com/uppy/v2.11.1-0/uppy.min.css" rel="stylesheet">

<!-- 2. Add JS before the closing `</body>` -->
<script src="https://releases.transloadit.com/uppy/v2.11.1-0/uppy.min.js"></script>
...
```html
<script src="https://releases.transloadit.com/uppy/v2.11.1-0/uppy.legacy.min.js"></script>
```
