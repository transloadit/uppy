...
Add CSS [uppy.min.css](https://transloadit.edgly.net/releases/uppy/v0.27.4/dist/uppy.min.css), either to `<head>` of your HTML page or include in JS, if your bundler of choice supports it — transforms and plugins are available for Browserify and Webpack.
