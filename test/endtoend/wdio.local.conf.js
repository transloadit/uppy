...
// Use "yarn run test:endtoend:local -- -b chrome" to test in chrome
// "yarn run test:endtoend:local -- -b ie" to test in internet explorer
// "yarn run test:endtoend:local -- -b firefox -b chrome" to test in FF and chrome
const capabilities = []
if (args.b) {
