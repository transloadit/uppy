...
| ------------------------- | ------------ | ------------------------- | ------------ |
| @uppy/audio               | 2.0.0-beta.5 | @uppy/provider-views      | 4.0.0-beta.5 |
| @uppy/aws-s3              | 4.0.0-beta.3 | @uppy/react               | 4.0.0-beta.5 |
| @uppy/aws-s3-multipart    | 4.0.0-beta.5 | @uppy/react-native        | 1.0.0-beta.1 |
