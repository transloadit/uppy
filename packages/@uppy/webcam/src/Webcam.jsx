    ...
    this.icon = () => (
      <svg aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32">
        <g fill="none" fillRule="evenodd">
          ...
          <path d="M22.75 10.25c1.275 0 2.25.975 2.25 2.25v8.25c0 1.275-.975 2.25-2.25 2.25H9.25C7.975 23 7 22.025 7 20.75V12.5c0-1.275.975-2.25 2.25-2.25h2.625L13.15 8.3c.15-.15.375-.3.6-.3h4.5c.225 0 .45.15.6.3l1.275 1.95h2.625zM16 11.975a4.235 4.235 0 00-4.275 4.275A4.234 4.234 0 0016 20.526a4.233 4.233 0 004.275-4.275c0-2.397-1.881-4.276-4.275-4.276zm0 7.043c-1.57 0-2.768-1.199-2.768-2.767 0-1.57 1.199-2.769 2.768-2.769 1.57 0 2.767 1.2 2.767 2.768 0 1.569-1.198 2.768-2.767 2.768z" fill="#02B383" fillRule="nonzero" />
        </g>
      </svg>
    )
