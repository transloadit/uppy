...
- 2608031: Fix the `state_referenced_locally` warning emitted for `UppyContextProvider`, and make the provided context follow the `uppy` prop instead of capturing its initial value
