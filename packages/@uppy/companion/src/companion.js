...
module.exports.app = (options = {}) => {
  ...
  app.use((req, res, next) => {
    const appHeaders = (res.getHeaders()['access-control-allow-methods']).replaceAll(/ /g, '')
    const mergedHeaders = ([...new Set([...appHeaders.split(','), ...('GET,POST,OPTIONS,DELETE').split(',')])]).join()
