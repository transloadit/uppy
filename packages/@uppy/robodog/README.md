...
```html
<link rel="stylesheet" href="https://releases.transloadit.com/uppy/v2.12.2/robodog.min.css">
<script src="https://releases.transloadit.com/uppy/v2.12.2/robodog.min.js"></script>
```
