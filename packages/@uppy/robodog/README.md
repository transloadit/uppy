...
```html
<link rel="stylesheet" href="https://releases.transloadit.com/uppy/v1.23.3/robodog.min.css">
<script src="https://releases.transloadit.com/uppy/v1.23.3/robodog.min.js"></script>
```
