...
```html
<link rel="stylesheet" href="https://releases.transloadit.com/uppy/v1.23.2/robodog.min.css">
<script src="https://releases.transloadit.com/uppy/v1.23.2/robodog.min.js"></script>
```
