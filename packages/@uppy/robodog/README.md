...
```html
<link rel="stylesheet" href="https://releases.transloadit.com/uppy/v1.28.1/robodog.min.css">
<script src="https://releases.transloadit.com/uppy/v1.28.1/robodog.min.js"></script>
```
