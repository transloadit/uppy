...
```html
<link rel="stylesheet" href="https://transloadit.edgly.net/releases/uppy/v1.11.0/robodog.min.css">
<script src="https://transloadit.edgly.net/releases/uppy/v1.11.0/robodog.min.js"></script>
```
