...
```html
<link rel="stylesheet" href="https://releases.transloadit.com/uppy/v1.28.0/robodog.min.css">
<script src="https://releases.transloadit.com/uppy/v1.28.0/robodog.min.js"></script>
```
