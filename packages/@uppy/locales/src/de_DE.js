...
de_DE.strings = {
  ...
  dropHereOr: 'Ziehen Sie Dateien über Drag/Drop hierher oder %{browse}',
  dropHint: 'Ziehen Sie Dateien über Drag/Drop hierher',
  dropPaste: 'Ziehen Sie Dateien über Drag/Drop hierher, fügen Sie sie ein, oder %{browse}',
  dropPasteImport: 'Ziehen Sie Dateien über Drag/Drop hierher, fügen Sie sie ein, %{browse} oder importieren Sie sie von',
  edit: 'Bearbeiten',
  editFile: 'Datei bearbeiten',
  editing: '%{file} bearbeiten',
  emptyFolderAdded: 'Keine Dateien wurden aus dem leeren Ordner hinzugefügt',
  encoding: 'Enkodieren...',
  enterCorrectUrl: 'Falsche URL: Bitte stellen Sie sicher, dass einen direkten Link zu einer Datei eingeben',
