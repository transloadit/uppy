...
An [Uppy Companion](https://uppy.io/docs/companion) instance is required for the Instagram plugin to work. Uppy Companion handles authentication with Instagram, downloads the pictures and videos, and uploads them to the destination. This saves the user bandwidth, especially helpful if they are on a mobile connection.
