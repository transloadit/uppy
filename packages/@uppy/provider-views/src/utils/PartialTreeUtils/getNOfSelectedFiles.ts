...
// I believe it's the most intuitive number we can show to the user given we don't have full information about how many files are inside of each selected folder.
