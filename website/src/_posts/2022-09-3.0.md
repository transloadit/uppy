...
In Uppy 3.0 we went full-on ESM, released Companion 4.0 with new upload streaming support, new Remote Sources plugin and fixed over 95 bugs (scientifically counted).
...
```js
uppy.use(Instagram, { companionUrl: COMPANION_URL, companionAllowedHosts: COMPANION_ALLOWED_HOSTS })
...
Since 2.7 release we’ve fixed over 95 bugs!
