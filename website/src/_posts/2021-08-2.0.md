...
**Note:** some bundlers will include `UIPlugin` (and therefor Preact) if you import from `@uppy/core`. To make sure this does not happen, you can import `Uppy` and `BasePlugin` directly: 
