...
Uppy 2.0 is smaller and faster, thanks to dropping support for IE11 and a lot of refactorings. We’ve upgraded to Preact X and other dependencies, improved TypeScript support and screenreader accessibility, and added support for multiple messages in the Informer plugin.
