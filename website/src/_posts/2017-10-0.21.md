...
- The S3 plugin now includes XHRUpload. **You should remove `.use(XHRUpload)` when using S3.**
...
- Renamed `RestoreFiles` → `GoldenRetriever`, and `Tus10` → `Tus`. Please make sure to use the new names when setting up plugins.
