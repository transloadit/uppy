...
<small>or include it [from the CDN version](https://uppy.io/docs/)</small>

Note that it’s recommended to [pick and choose specific Uppy plugins](https://uppy.io/docs/plugins/#package-list) and install them with `npm` or `yarn`, instead of using the bundle that includes all plugins.
