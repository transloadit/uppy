...
We didn't manage to fit all of those _To Do_s in the picture, but here is a screenshot of what our board looks like at the moment:
...
And tomorrow, we'll look at the _To Do_s in more detail, so we can get a clearer idea of subtasks and who will do what, exactly.
