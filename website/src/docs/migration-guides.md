...
<script nomodule src="https://releases.transloadit.com/uppy/v2.9.0/uppy.legacy.min.js"></script>
<script type="module">import "https://releases.transloadit.com/uppy/v2.9.0/uppy.min.js";</script>
```
