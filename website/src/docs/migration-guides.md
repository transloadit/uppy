...
<script src="https://releases.transloadit.com/uppy/v3.2.0/uppy.min.js"></script>

<!-- Legacy browsers (IE11+) -->
<script nomodule src="https://releases.transloadit.com/uppy/v3.2.0/uppy.legacy.min.js"></script>
<script type="module">import "https://releases.transloadit.com/uppy/v3.2.0/uppy.min.js";</script>
```
