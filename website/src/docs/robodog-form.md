...
```html
<!-- The new Robodog way! -->
<script src="//transloadit.edgly.net/releases/uppy/robodog/v1.9.7/robodog.min.js"></script>
...
```html
<head>
  <link rel="stylesheet" href="https://transloadit.edgly.net/releases/uppy/robodog/v1.9.7/robodog.min.css">
</head>
```
