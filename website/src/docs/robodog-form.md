...
```html
<head>
  <link rel="stylesheet" href="https://transloadit.edgly.net/releases/uppy/robodog/v1.6.4/robodog.min.css">
</head>
```
...
<html>
  ...
  <body>
    ...
    <script src="https://transloadit.edgly.net/releases/uppy/robodog/v1.6.4/robodog.min.js"></script>
