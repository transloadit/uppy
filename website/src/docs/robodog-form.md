...
```html
<head>
  <link rel="stylesheet" href="https://releases.transloadit.com/uppy/robodog/v2.9.5/robodog.min.css">
</head>
```
...
<html>
  ...
  <body>
    ...
    <script src="https://releases.transloadit.com/uppy/robodog/v2.9.5/robodog.min.js"></script>
