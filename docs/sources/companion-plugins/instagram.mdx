...
Among Uppy-supported providers, Instagram is the only provider at the time of writing that requires
https even in dev mode. So, to test your integration in development, you need to
use some reverse proxy. The easiest way to do it is to use
