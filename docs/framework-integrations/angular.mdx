...
- Import `UppyAngularDashboardModalModule` used as
  `<uppy-dashboard-modal> renders [`@uppy/dashboard`](/docs/dashboard) as a
  modal
- Import `UppyAngularProgressBarModule` used as `<uppy-progres-bar>` renders
