...
},{"../plugins/TransloaditPlugin":3}],3:[function(require,module,exports){
"use strict";
...
},{"./TransloaditPlugin":3}],5:[function(require,module,exports){
'use strict';

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

var _srcCoreTransloadit = require('./src/core/Transloadit');

var _srcCoreTransloadit2 = _interopRequireDefault(_srcCoreTransloadit);

var _srcPluginsDragDrop = require('./src/plugins/DragDrop');

var _srcPluginsDragDrop2 = _interopRequireDefault(_srcPluginsDragDrop);

var _srcPluginsTus10 = require('./src/plugins/Tus10');

var _srcPluginsTus102 = _interopRequireDefault(_srcPluginsTus10);

var transloadit = new _srcCoreTransloadit2['default']({ wait: false });
var files = transloadit.use(_srcPluginsDragDrop2['default'], { modal: true }).use(_srcPluginsTus102['default'], { endpoint: 'http://master.tus.io:8080' }).run();

console.log('--> Finished transloadit. Final result: ');
console.dir(files);

},{"./src/core/Transloadit":1,"./src/plugins/DragDrop":2,"./src/plugins/Tus10":4}]},{},[5]);
