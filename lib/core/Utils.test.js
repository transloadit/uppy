...
describe('core/utils', function () {
  ...
  describe('getFileNameAndExtension', function () {
    it('should return the filename and extension as an array', function () {
      expect(_Utils2.default.getFileNameAndExtension('fsdfjodsuf23rfw.jpg')).toEqual({
    ...
    it('should handle invalid filenames', function () {
      expect(_Utils2.default.getFileNameAndExtension('fsdfjodsuf23rfw')).toEqual({
        name: 'fsdfjodsuf23rfw',
        extension: undefined
      });
    });
  ...
  describe('settle', function () {
    it('should resolve even if all input promises reject', function () {
      return expect(_Utils2.default.settle([Promise.reject(new Error('oops')), Promise.reject(new Error('this went wrong'))])).resolves.toMatchObject({
        successful: [],
  ...
  describe('limitPromises', function () {
    ...
    it('should run at most N promises at the same time', function () {
      var limit = _Utils2.default.limitPromises(4);
      var fn2 = limit(fn);

      var result = Promise.all([fn2(), fn2(), fn2(), fn2(), fn2(), fn2(), fn2(), fn2(), fn2(), fn2()]);
    ...
    it('should accept Infinity as limit', function () {
      var limit = _Utils2.default.limitPromises(Infinity);
      var fn2 = limit(fn);
