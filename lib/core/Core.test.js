...
describe('src/Core', function () {
  ...
  describe('adding a file', function () {
    ...
    it('should call utils.generatePreview when core:file-added is triggered and thumbnail generation is allowed', function () {
      ...
      expect(_Utils2.default.createThumbnail.mock.calls[0][1]).toEqual(200);
    });

    it('should return an object url of the image when core:file-added is triggered and thumbnail generation is disabled', function () {
      var core = new _Core2.default({
